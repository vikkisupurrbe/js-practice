...
function gradeAnalyzer(data) {

  let scores = data.map(student => student.score);
  let students = data;
  ...
  return { studentScores, average, topStudents, removeFailing };
}
...
const myGradeAnalyzer = gradeAnalyzer(students);
